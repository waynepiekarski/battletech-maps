...
palette=(
000000 000000 61B600 41B679 B62000 4179FF B64100 797979 616161 2041B6
79FF41 61FFFF FF4120 FF61FF FFFF20 FFFFFF 000000 101010 202020 353535
...
cat <<EOF
unsigned char btech_palette[4*256] = {
EOF
...
do
  RED="$(echo ${palette[$i]} | cut -c1-2)"
  GREEN="$(echo ${palette[$i]} | cut -c3-4)"
  BLUE="$(echo ${palette[$i]} | cut -c5-6)"
  ALPHA="FF"
  cat <<EOF
0x${RED}, 0x${GREEN}, 0x${BLUE}, 0x${ALPHA},
EOF
done
